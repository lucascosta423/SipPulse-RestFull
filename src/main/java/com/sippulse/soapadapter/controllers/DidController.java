...
public class DidController {
    ...
    public ResponseEntity<ApiResponse<List<String>>> listAvailableNumbers(@RequestParam String domain, HttpServletRequest request) {
        return ResponseEntity.ok(
                ApiResponse.success(
                        didService.listAvailableNumbers(domain),
                        "Available Dids",
                        HttpStatus.OK.value(),
    ...
    @PostMapping
    public ResponseEntity<ApiResponse<Integer>> insertDid(@RequestBody @Valid DidDTO didDTO,HttpServletRequest request) {
